...
func (m *Metrics) RecordHttpLatency(ctx context.Context, t time.Duration, method, path string, status int, ttfb bool) {
	m.httpLatency.Record(ctx, t.Milliseconds(),
		attribute.String("method", method), attribute.String("path", path), attribute.Int("status", status), attribute.Bool("ttfb", ttfb))
}
